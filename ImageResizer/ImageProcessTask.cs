...
namespace ImageResizer
{
    public class ImageProcessTask
    {
        ...
        /// <returns></returns>
        private static Bitmap ProcessBitmap(Image img, int srcWidth, int srcHeight, int newWidth, int newHeight)
        {
            var resizedBitmap = new Bitmap(newWidth, newHeight);
            var image = Graphics.FromImage(resizedBitmap);
            image.InterpolationMode = InterpolationMode.High;
